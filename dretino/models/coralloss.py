...
from dretino.models.utils import levels_from_labelbatch, coral_loss, proba_to_label, CoralLayer
...
class ModelCORAL(nn.Module):
    def __init__(self, model_name, num_classes=5, additional_layers=True, num_neurons=512, n_layers=2, dropout_rate=0.2):
        ...
        if self.additional_layers:
            ...
            self.model.fc = CoralLayer(size_in=num_features, num_classes=self.num_classes)
